...
data_table %>% 
  kbl(caption="<b>Table 1 | </b> Demographics", align=rep('l', 5),
      format = "html", table.attr = "style='width:35%;'") %>% 
  kable_classic(html_font = "Cambria") %>% 
  save_kable("tables/Demographics.pdf")
...
table_bayesian %>% 
  ...
  kable_classic(html_font = "Cambria") %>%
  save_kable("tables/Hierarchical Bayesian Meta-Analysis.pdf")
...
table_unpooled %>% 
  kbl(caption="<b>Table 3 | </b> Unpooled Analysis",
      format = "html", table.attr = "style='width:50%;'") %>% 
  kable_classic(html_font = "Cambria") %>% 
  save_kable("tables/Unpooled Analysis.pdf")
...
In this section we perform a Bayesian unpooled analysis to explore the role of financial literacy, i.e., are people with higher levels of financial literacy less susceptible to the mental accounting effect?
